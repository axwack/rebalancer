...
LEXERS = {
    ...
    'BashLexer': ('pygments.lexers.shell', 'Bash', ('bash', 'sh', 'ksh', 'shell'), (
    '*.sh', '*.ksh', '*.bash', '*.ebuild', '*.eclass', '.bashrc', 'bashrc', '.bash_*', 'bash_*', 'PKGBUILD'),
                  ('application/x-sh', 'application/x-shellscript')),
    'BashSessionLexer': (
    'pygments.lexers.shell', 'Bash Session', ('console',), ('*.sh-session',), ('application/x-shell-session',)),
    ...
    'CommonLispLexer': (
    'pygments.lexers.lisp', 'Common Lisp', ('common-lisp', 'cl', 'lisp', 'elisp', 'emacs', 'emacs-lisp'),
    ('*.cl', '*.lisp', '*.el'), ('text/x-common-lisp',)),
    ...
    'DelphiLexer': (
    'pygments.lexers.pascal', 'Delphi', ('delphi', 'pas', 'pascal', 'objectpascal'), ('*.pas',), ('text/x-pascal',)),
    ...
    'FortranLexer': (
    'pygments.lexers.fortran', 'Fortran', ('fortran',), ('*.f', '*.f90', '*.F', '*.F90'), ('text/x-fortran',)),
    ...
    'JavascriptLexer': ('pygments.lexers.javascript', 'JavaScript', ('js', 'javascript'), ('*.js',),
    ...
    'NewLispLexer': (
    'pygments.lexers.lisp', 'NewLisp', ('newlisp',), ('*.lsp', '*.nl'), ('text/x-newlisp', 'application/x-newlisp')),
    ...
    'Perl6Lexer': ('pygments.lexers.perl', 'Perl6', ('perl6', 'pl6'),
    ...
    'pygments.lexers.python', 'Python 3.0 Traceback', ('py3tb',), ('*.py3tb',), ('text/x-python3-traceback',)),
    'PythonConsoleLexer': (
    'pygments.lexers.python', 'Python console session', ('pycon',), (), ('text/x-python-doctest',)),
    'PythonLexer': ('pygments.lexers.python', 'Python', ('python', 'py', 'sage'),
                    ('*.py', '*.pyw', '*.sc', 'SConstruct', 'SConscript', '*.tac', '*.sage'),
                    ('text/x-python', 'application/x-python')),
    'PythonTracebackLexer': (
    'pygments.lexers.python', 'Python Traceback', ('pytb',), ('*.pytb',), ('text/x-python-traceback',)),
    ...
    'RobotFrameworkLexer': (
    'pygments.lexers.robotframework', 'RobotFramework', ('robotframework',), ('*.txt', '*.robot'),
    ...
    'ShellSessionLexer': (
    'pygments.lexers.shell', 'Shell Session', ('shell-session',), ('*.shell-session',), ('application/x-sh-session',)),
