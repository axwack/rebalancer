    ...
    a.extend(a.jqx._jqxListBox.prototype, {
        defineInstance: function () {
            ...
            if (this.itemsByValue) {
                return this.itemsByValue[a.trim(d).split(" ").join("_")]
            }
            ...
            if (t.rtl) {
                ...
                if (t.filterable && t.filterInput) {
                    t.filterInput.css({left: t.vScrollBar.width() + 6 + "px"})
                }
            }
            ...
            if (this.fromSelect == undefined || this.fromSelect == false) {
                for (var h = 0; h < d; h++) {
                    ...
                    if (h == 0 && r.caption == "" && r.captionHtml == "" && d <= 1) {
                        for (var g = 0; g < r.items.length; g++) {
                            ...
                            this.itemsByValue[a.trim(q).split(" ").join("_")] = r.items[g]
                        }
                        return r.items
                    } else {
                    ...
                    for (var f = 0; f < r.items.length; f++) {
                        ...
                        t.itemsByValue[a.trim(q).split(" ").join("_")] = r.items[f];
                        p++
                    }
                }
            } else {
                ...
                a.each(e, function () {
                    ...
                    t.itemsByValue[a.trim(j).split(" ").join("_")] = this;
                    p++
                })
            }
            return c
            ...
            if (d != null) {
                ...
                this.itemsByValue[a.trim(b.value).split(" ").join("_")] = this.items[c];
            ...
            if (this.items == undefined || this.items.length == 0) {
                ...
                this.itemsByValue[a.trim(k).split(" ").join("_")] = g;
                return false
            }
            var g = this._mapItem(l);
            ...
            this.itemsByValue[a.trim(n).split(" ").join("_")] = null;
            if (this.groups.length > 1) {
                var h = new Array();
                for (var b = 0; b < this.items.length; b++) {
                    if (!this.items[b].isGroup) {
            ...
            for (var g = 0; g < this.items.length; g++) {
                ...
                this.itemsByValue[a.trim(n).split(" ").join("_")] = this.items[g]
            }
            if (this.rendered) {
                this.rendered()
            }
